...
class mgpdEPostsList extends \Elementor\Widget_Base
{
    ...
    function register_content_controls()
    {
        ...
        $this->register_query_source_controls('mgpl_query_source', 'mgpl_query_auto_notice', 'mgpl_archive_posts_per_page');
        ...
        $this->register_post_position_control('mgpl_posts_filter', 'mgpl_query_source');
        ...
        $this->register_pagination_section_controls('mgpl_query_source');
    ...
    protected function render()
    {
        ...
        $mgpg_pagination_show = $this->should_show_pagination($settings, 'mgpl_query_source', 'mgpg_pagination_show');
