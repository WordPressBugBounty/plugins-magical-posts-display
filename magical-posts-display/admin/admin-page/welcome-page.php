			...
			<div class="cols">
				...
				<div class="col-2">
					<div class="mgftext">
						...
						<a href="<?php echo esc_url(get_admin_url()); ?>post-new.php?post_type=page" class="button button-mgp1 button-mgp2"><?php esc_html_e('Create Your Page With Magical Posts Blocks', 'magical-post-display'); ?></a>
					</div>
				</div>
			</div>
		</section>
					...
					<div class="col-4">
						<div class="mgvideo">
							<a class="btn btn-danger venoboxvid btn-lg vbox-item mgyouvideo" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=Dta4CwqvILI">
								<img src="https://img.youtube.com/vi/Dta4CwqvILI/0.jpg" alt="<?php echo esc_attr__('Video tutorial', 'magical-post-display'); ?>">
							</a>
					...
					<div class="col-4">
						<div class="mgvideo">
							<a class="btn btn-danger venoboxvid btn-lg vbox-item mgyouvideo" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=cGGZjLLFTao">
								<img src="https://img.youtube.com/vi/cGGZjLLFTao/0.jpg" alt="<?php echo esc_attr__('Video tutorial', 'magical-post-display'); ?>">
							</a>
					...
					<div class="col-4">
						<div class="mgvideo">
							<a class="btn btn-danger venoboxvid btn-lg vbox-item mgyouvideo" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=EurYISxEtec">
								<img src="https://img.youtube.com/vi/EurYISxEtec/0.jpg" alt="<?php echo esc_attr__('Video tutorial', 'magical-post-display'); ?>">
							</a>
					...
					<div class="col-4">
						<div class="mgvideo">
							<a class="btn btn-danger venoboxvid btn-lg vbox-item mgyouvideo" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=bsXWQ9y79Ew">
								<img src="https://img.youtube.com/vi/bsXWQ9y79Ew/0.jpg" alt="<?php echo esc_attr__('Video tutorial', 'magical-post-display'); ?>">
							</a>
					...
					<div class="col-4">
						<div class="mgvideo">
							<a class="btn btn-danger venoboxvid btn-lg vbox-item mgyouvideo" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=R-aOHV5EPpU">
								<img src="https://img.youtube.com/vi/R-aOHV5EPpU/0.jpg" alt="<?php echo esc_attr__('Video tutorial', 'magical-post-display'); ?>">
							</a>
					...
					<div class="col-4">
						<div class="mgvideo">
							<a class="btn btn-danger venoboxvid btn-lg vbox-item mgyouvideo" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=rj3gZ62Wtxo">
								<img src="https://img.youtube.com/vi/rj3gZ62Wtxo/0.jpg" alt="<?php echo esc_attr__('Video tutorial', 'magical-post-display'); ?>">
							</a>
